...
// (JSON blob, single round-trip) instead of the legacy components +
...
// methods always emit plain Uint8Array, so plaintext is normalised to
// plain Uint8Array up front to keep `assert.deepEqual` happy on the
// strict prototype check.
function rng(n: number): Uint8Array {
  return new Uint8Array(randomBytes(n));
}

describe('test_easy_areion', () => {
