// ChaCha20-focused Node.js / TypeScript binding coverage.
//
...
// (hash, ITB_seed_width) — ChaCha20 ships only at -256. The width
...
// contract that ChaCha20 carries a 32-byte fixed key.
